...
import { FaSun, FaMoon, FaBars, FaTimes } from 'react-icons/fa'; // Icons for dark mode toggle and mobile menu
...
const Navbar = () => {
  ...
  return (
    <nav className={`bg-black dark:bg-gray-900 text-white px-8 md:px-16 lg:px-24`}>
